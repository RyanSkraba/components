...
public class AzureStorageDeleteReaderTest {

    AzureStorageDeleteReader reader;

    @Before
    public void setUp() throws Exception {
        AzureStorageSource sos = new AzureStorageSource();
        TAzureStorageDeleteProperties properties = new TAzureStorageDeleteProperties("tests");
        properties.setupProperties();
        properties.container.setValue("test");
        sos.initialize(null, properties);
        reader = (AzureStorageDeleteReader) sos.createReader(null);
    }
