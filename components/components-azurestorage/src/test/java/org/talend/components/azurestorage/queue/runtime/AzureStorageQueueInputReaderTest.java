...
public class AzureStorageQueueInputReaderTest {

    AzureStorageQueueInputReader reader;

    @Before
    public void setUp() throws Exception {
        AzureStorageQueueSource sos = new AzureStorageQueueSource();
        TAzureStorageQueueInputProperties properties = new TAzureStorageQueueInputProperties("tests");
        properties.setupProperties();
        properties.queueName.setValue("test");
        sos.initialize(null, properties);
        reader = (AzureStorageQueueInputReader) sos.createReader(null);
    }
