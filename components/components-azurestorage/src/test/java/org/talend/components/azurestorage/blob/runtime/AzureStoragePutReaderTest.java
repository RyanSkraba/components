...
public class AzureStoragePutReaderTest {

    AzureStoragePutReader reader;

    @Before
    public void setUp() throws Exception {
        AzureStorageSource sos = new AzureStorageSource();
        TAzureStoragePutProperties properties = new TAzureStoragePutProperties("tests");
        properties.setupProperties();
        properties.container.setValue("test");
        sos.initialize(null, properties);
        reader = (AzureStoragePutReader) sos.createReader(null);
    }
