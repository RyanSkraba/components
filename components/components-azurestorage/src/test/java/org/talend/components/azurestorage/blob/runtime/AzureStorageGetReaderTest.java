...
public class AzureStorageGetReaderTest {

    AzureStorageGetReader reader;

    @Before
    public void setUp() throws Exception {
        AzureStorageSource sos = new AzureStorageSource();
        TAzureStorageGetProperties properties = new TAzureStorageGetProperties("tests");
        properties.setupProperties();
        properties.container.setValue("test");
        sos.initialize(null, properties);
        reader = (AzureStorageGetReader) sos.createReader(null);
    }
