...
/**
 * Integration tests for Couchbase component, which check if nothing was missed
 * during component implementation
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = SpringTestApp.class)
public class SpringCouchbaseComponentsTestIT extends CouchbaseComponentsTestBase {
