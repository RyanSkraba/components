...
@Component(name = Constants.COMPONENT_BEAN_PREFIX + MongoDBExtractDefinition.COMPONENT_NAME, provide = ComponentDefinition.class)
public class MongoDBExtractDefinition extends RejectableTransormationDefinition {

    public static final String COMPONENT_NAME = "tMongDBExtractNew"; //$NON-NLS-1$

    public static final String POM_LOCATION = "/org/talend/components/filtercolumn/pom.xml";

    public MongoDBExtractDefinition() {
    ...
    public Class<?> getPropertyClass() {
        ...
        // content of it.
        return MongoDBExtractProperties.class;
    }
