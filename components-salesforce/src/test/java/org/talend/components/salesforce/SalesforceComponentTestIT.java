...
public class SalesforceComponentTestIT extends SalesforceTestBase {
    ...
    public void testSerializationIssue_TUP_4851() {
        ...
        Deserialized<ComponentProperties> fromSerializedPersistent = Properties.Helper.fromSerializedPersistent(serialized,
                ComponentProperties.class);
        System.out.println(fromSerializedPersistent.object.toString());
    }
