...
public class DefaultComponentRuntimeContainerImplTest {
    ...
    public void testGlobalMap() {
        DefaultComponentEngineImpl runtimeContainer = new DefaultComponentEngineImpl();
    ...
    public void testCreateDynamicHolder() {
        DefaultComponentEngineImpl runtimeContainer = new DefaultComponentEngineImpl();
        DefaultComponentEngineImpl.Dynamic schema = runtimeContainer.createDynamicHolder();
