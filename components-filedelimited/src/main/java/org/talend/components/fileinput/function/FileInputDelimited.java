...
public class FileInputDelimited {
	 ...
	 * 
	 */
	public FileInputDelimited(String file, String encoding, String fieldSeparator, String rowSeparator,
	 ...
	 * 
	 */
	public FileInputDelimited(InputStream is, String encoding, String fieldSeparator, String rowSeparator,
			boolean skipEmptyRow, int header, int footer, int limit, int random) throws IOException {
	 ...
	 */
	public FileInputDelimited(InputStream is, String encoding, String fieldSeparator, String rowSeparator,
			boolean skipEmptyRow, int header, int footer, int limit, int random, boolean splitRecord)
					throws IOException {
		if (header < 0) {
			header = 0;
		}
		...
		if (random != 0 && limit != 0) {
			...
			if (random < 0 && footer == 0) {
				...
				this.delimitedDataReader = new TOSDelimitedReader(is, encoding, fieldSeparator, rowSeparator,
						skipEmptyRow);
				this.delimitedDataReader.setSplitRecord(splitRecord);
	...
	public FileInputDelimited(String file, String encoding, String fieldSeparator, String rowSeparator,
		...
		if (random != 0 && limit != 0) {
			this.delimitedDataReader = new TOSDelimitedReader(file, encoding, fieldSeparator, rowSeparator,
					skipEmptyRow);
			this.delimitedDataReader.setSplitRecord(splitRecord);
	 ...
	 * @throws IOException
	 */
	public FileInputDelimited(String content, String fieldSeparator, String rowSeparator, boolean skipEmptyRow,
		...
		if (random != 0 && limit != 0) {
			...
			this.delimitedDataReader = new TOSDelimitedReader(stringReaderOne, fieldSeparator, rowSeparator,
					skipEmptyRow);
			this.delimitedDataReader.setSplitRecord(splitRecord);
			...
			if (random < 0 && footer == 0) {
				...
				this.delimitedDataReader = new TOSDelimitedReader(stringReaderTwo, fieldSeparator, rowSeparator,
						skipEmptyRow);
				this.delimitedDataReader.setSplitRecord(splitRecord);
	...
	public static int getMaxColumnCount(String fileName, String encoding, String fieldDelimiter, String recordDelimiter,
		...
		TOSDelimitedReader tosDelimitedReader = new TOSDelimitedReader(fileName, encoding, fieldDelimiter,
				recordDelimiter, needSkipEmptyRecord);
