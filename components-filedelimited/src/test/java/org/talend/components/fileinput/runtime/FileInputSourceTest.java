...
public class FileInputSourceTest {
	...
	private TFileInputDelimitedDefinition definition;

	@Before
	public void setInputSource() {
		definition = (TFileInputDelimitedDefinition) (componentService.getComponentDefinition("tDatasetInput"));
		inputSource = (FileInputSource) definition.getRuntime();
	}
