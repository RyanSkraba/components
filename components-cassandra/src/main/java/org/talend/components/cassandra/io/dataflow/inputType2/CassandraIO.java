...
public class CassandraIO {
    ...
    public static final class Read {
        ...
        public static class Bound<T> extends PTransform<PInput, PCollection<T>> {
            ...
            private Bound(String name, tCassandraInputDIProperties properties) {
                super(name);
            ...
            public Bound<T> from(tCassandraInputDIProperties properties) {
                return new Bound<>(name, properties);
            }

            public tCassandraInputDIProperties getProperties() {
                return properties;
            }
