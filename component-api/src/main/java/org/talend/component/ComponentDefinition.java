...
public abstract class ComponentDefinition {
    ...
    /**
     * Component categorization - this is an issue that wants further study. -
     * which designer (big data, di, etc) and then which family.
     */
    public enum Family {
        BUSINESS, CLOUD
    }
    ...
    /*
    Intercomponent property references - need examples for this. - shared clumps of properties, referring to properties
    in the same job, refers to properties upstream in the connection.
